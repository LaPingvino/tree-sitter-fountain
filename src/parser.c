...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 38:
      ...
      if (('\t' <= lookahead && lookahead <= '\r')) ADVANCE(175);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(293);
      if (('A' <= lookahead && lookahead <= 'Z')) ADVANCE(276);
      if (lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(294);
      if (set_contains(sym_character_character_set_3, 656, lookahead)) ADVANCE(300);
    ...
    case 41:
      ...
      if (('\t' <= lookahead && lookahead <= '\r')) ADVANCE(258);
    ...
    case 42:
      ...
      if (('A' <= lookahead && lookahead <= 'Z')) ADVANCE(279);
      if (set_contains(sym_character_character_set_1, 656, lookahead)) ADVANCE(300);
      if (lookahead != 0) ADVANCE(307);
      END_STATE();
    case 43:
      ADVANCE_MAP(
    ...
    case 189:
      ...
      if (set_contains(sym_character_character_set_5, 658, lookahead)) ADVANCE(207);
    ...
    case 190:
      ...
      if (set_contains(sym_character_character_set_5, 658, lookahead)) ADVANCE(243);
      if (lookahead != 0) ADVANCE(173);
      END_STATE();
    case 191:
      ACCEPT_TOKEN(sym__line);
    ...
    case 204:
      ...
      if (set_contains(sym_character_character_set_5, 658, lookahead)) ADVANCE(265);
      if (lookahead != 0) ADVANCE(143);
      END_STATE();
    case 205:
      ACCEPT_TOKEN(sym__line);
    ...
    case 213:
      ...
      if (set_contains(sym_character_character_set_5, 658, lookahead)) ADVANCE(213);
      if (lookahead != 0) ADVANCE(149);
      END_STATE();
    case 214:
      ACCEPT_TOKEN(sym__line);
    ...
    case 228:
      ...
      if (lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(164);
      if (set_contains(sym_character_character_set_5, 658, lookahead)) ADVANCE(241);
      if (lookahead != 0) ADVANCE(168);
      END_STATE();
    case 229:
      ACCEPT_TOKEN(sym__line);
    ...
    case 277:
      ...
      if (lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(289);
      if (set_contains(sym_character_character_set_3, 656, lookahead)) ADVANCE(207);
      if (lookahead != 0) ADVANCE(291);
      END_STATE();
    case 278:
      ACCEPT_TOKEN(sym__line);
    ...
    case 282:
      ...
      if (lookahead == ' ' ||
          ...
          lookahead == '.' ||
          ('A' <= lookahead && lookahead <= 'Z')) ADVANCE(266);
      if (set_contains(sym_character_character_set_3, 656, lookahead)) ADVANCE(265);
      if (lookahead != 0) ADVANCE(143);
      END_STATE();
    case 283:
      ACCEPT_TOKEN(sym__line);
